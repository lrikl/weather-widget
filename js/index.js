...
async function updateWeather() {
  try {
    ...
    humidityElement.innerHTML = `Вологість: <br> ${data.main.humidity} %`;
    windElement.innerHTML = `Вітер: <br> ${data.wind.speed} м/с`;
    pressureElement.innerHTML = `Тиск: <br> ${data.main.pressure} гПа`;
